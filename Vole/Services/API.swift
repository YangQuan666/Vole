...
public struct V2exAPI {
    ...
    private func request<T>(httpMethod: String = "GET", url: String, args: [String: Any]? = nil, decodeClass: T.Type) async throws -> (
        ...
        if let remainingStr = httpResponse.value(forHTTPHeaderField: "X-Rate-Limit-Remaining"),
    ...
    /**
     获取节点列表
     */
    public func nodesList(fields: [String]? = nil, sortBy: String = "topics", reverse: String = "1") async throws -> [Node]? {
     ...
     */
    public func memberShow(username: String? = nil, id: Int? = nil) async throws -> Member? {
     ...
     */
    public func topics(nodeName: String, page: Int = 1) async throws -> Response<[Topic]?>? {
    ...
    /**
     ...
     - parameter  page: 分页页码，默认为 1
     */
    public func replies(topicId: Int, page: Int = 1) async throws -> Response<[Reply]?>? {
    ...
    /**
     ...
     - parameter  page: 分页页码，默认为 1
     */
    public func notifications(page: Int = 1) async throws -> Response<[Notification]?>? {
     ...
     */
    public func deleteNotification(notificationId: Int) async throws -> Response<Data>? {
     ...
     */
    public func createToken(expiration: Int, scope: String? = nil) async throws -> Response<Token>? {
        let path = "token"
